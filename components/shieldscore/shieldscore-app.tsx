          ...
          <div className="grid gap-12 lg:grid-cols-[0.8fr_1.2fr]">
            ...
            <div className="space-y-6">
              ...
              {signalTrends.length > 0 && (
                <div className="border border-foreground/10 p-5">
                  <div className="mb-4 flex items-center justify-between">
                    <span className="font-mono text-xs uppercase text-muted-foreground">Category trends</span>
              ...
              <div className="flex flex-wrap gap-3">
                <ActionButton onClick={importWalletData} disabled={busy || !account}>
          ...
          <div>
            ...
            {scoreStale && (
              <p className="mb-6 text-sm text-muted-foreground">
                Your score needs a refresh before new borrowing because credit activity changed or the score expired.
              </p>
            )}
              ...
              {pools.map((pool) => {
                ...
                return (
                  <div key={pool.id} className="bg-background p-6">
                    ...
                    <div className="font-display text-4xl">{formatAssetAmount(pool, pool.liquidity)}</div>
            ...
            <p className="mt-6 text-sm text-muted-foreground">
              Required native collateral for selected borrow: {formatEth(requiredCollateral)} at {asPercent(borrowCollateralBps)}.
            </p>
          </div>
        )}
