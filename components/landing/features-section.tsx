...
const features = [
  ...
  {
    number: "02",
    title: "Score-Gated Lending Pools",
    description: "Borrowers access lender-defined pools when their verified score meets the threshold, with collateral tiers enforced on-chain.",
    visual: "ai",
  },
  {
    number: "03",
    title: "Repayment Feedback Loop",
    description: "Loan repayments, defaults, interest, and collateral recovery are recorded by the protocol and reflected in the borrower profile.",
    visual: "collab",
  },
  {
    number: "04",
    title: "Shareable Score Attestations",
    description: "Wallets can issue threshold attestations that prove score eligibility to other protocols without sharing the full profile.",
    visual: "security",
  },
];
  ...
  return (
    <svg viewBox="0 0 200 160" className="w-full h-full">
      ...
      {[0, 1, 2, 3, 4, 5].map((i) => {
        ...
        const radius = 50;
        const x = (100 + Math.cos(angle) * radius).toFixed(3);
        const y = (80 + Math.sin(angle) * radius).toFixed(3);
        return (
          <g key={i}>
            {/* Connection line */}
            <line
      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        <div className="mb-16 lg:mb-24">
          ...
          >
            Every core flow.
            <br />
            <span className="text-muted-foreground">On-chain end to end.</span>
          </h2>
        </div>
